...
\usepackage{hyperref}
%\usepackage{tabularx}
\makeindex[intoc, columns=3, title=German Index]
...
\begin{document}
	...
	\newpage
	\input{ClassicalMechanics.tex}
	\newpage
	\input{ClassicalFieldTheory.tex}
	\newpage
	\input{Electromagnetism.tex}
	\newpage
	\input{QuantumMechanics.tex}
	\newpage
	\input{QuantumFieldTheory.tex}
	\newpage
	\input{StatisticalMechanics.tex}
	\newpage
	\input{Formulary.tex}
	\newpage
	\input{Constants.tex}
