...
\section{Statistical Mechanics and Thermodynamics}
	...
	\subsection{Thermodynamics}
		...
		\subsubsection{Non-Equilibrium}
			...
			\newline\indent\emph{Aus der mikroskopischen Reversibilität folgen Dinge für die Entropieerzeugungsrate.}\vsp %TODO % cspell:disable-line
	...
	\subsection{Models}
		...
		\subsubsection{Quantum Mechanical Ideal Gas}
			...
			\begin{equation}
				\mathcal{Z} = \prod_{\alpha}
					\begin{cases}
						\left( 1-e^{\beta(\mu-\varepsilon_\alpha)}\right)^{-1} & \text{(Bosons)} \\
						\phantom{\big(} 1+e^{\beta(\mu-\varepsilon_\alpha)} & \text{(Fermions)}
					\end{cases}
			\end{equation}
			...
			\begin{equation}
				\overline{n_\alpha} =
					\begin{cases}
						\dfrac{1}{e^{\beta(\varepsilon_\alpha-\mu)} - 1} & \text{(Bosons)} \\
						\dfrac{1}{e^{\beta(\varepsilon_\alpha-\mu)} + 1} & \text{(Fermions)}
					\end{cases} \\
			\end{equation}
			...
			\begin{equation}
				\frac{pV}{N k_B T} = \frac{\sum_{l=1}^{\infty}\frac{z^l}{l^{5/2}}}{\dv{\ln z}\sum_{l=1}^{\infty}\frac{z^l}{l^{5/2}}}
			\end{equation}
		...
		\subsubsection{Black Body}
			...
			\begin{equation}
				\begin{aligned}
					\pdv{u}{\omega}(\omega,T) &= \frac{\hbar \omega^3}{\pi^2 c^3} \frac{1}{e^{\hbar \omega / k_B T} - 1} \\
					\pdv{u}{\nu} (\nu, T) &= \frac{8 \pi h \nu^3}{c^3} \frac{1}{e^{h \nu / k_B T} - 1} \\
				\end{aligned}
			\end{equation}
		...
		\subsubsection{Ideal Paramagnetism}
			...
			\begin{equation}
				\begin{aligned}
					...
					G(T,B_0) &= -k_B T \ln Z \\
					\mathcal{M}(T,B_0) &= -\left(\pdv{G}{B_0}\right)_T = N\mu \tanh(\mu B_0 /k_B T)
				\end{aligned}
			\end{equation}
