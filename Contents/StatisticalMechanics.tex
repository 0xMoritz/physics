...
\section{Statistical Mechanics and Thermodynamics}
	...
	\subsection{Thermodynamics}
		...
		\subsubsection{Non-Equilibrium}
			...
			\noindent
			Heat equation\index{Wärmeleitungsgleichung} (for $\dd u = nc_V \dd T$ (e.g. in solids); diffusion constant $D=\kappa/nc_V$):
			\begin{equation}
			...
			\newline\indent\emph{Aus der mikroskopischen Reversibilität folgen Dinge für die Entropieerzeugungsrate.}\vsp %TODO\vsp
