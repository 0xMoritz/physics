...
\section{Electromagnetism\index{Elektromagnetismus}}
	...
	+ q\frac{\diff x^\mu}{\diff \tau}A_\mu(x)\right)\;\diff\tau
		...
		\noindent
		Lorentz force\index{Lorentzkraft} (relativistic Minkowski force\index{Minkowskikraft} and Newtonian force):
		\begin{equation}
			\begin{aligned}
	...
	\subsection{Electrodynamics\index{Elektrodynamik}}
		\noindent
		Continuity equation\index{Kontinuitätsgleichung}:
		\begin{equation}
		...
		\subsubsection{Electromagnetic Energy and Momentum}
			...
			\noindent
			Poynting tector\index{Poynting!Vektor} / Energy flux density:
			\begin{equation}
				\vec{S} = \frac{1}{\mu_0}\vec{E}\times\vec{B}
			\end{equation}

			\noindent
			Poynting theorem\index{Poyngint!Theorem} / Energy continuity:
			\begin{equation}
				-\Nabla\cdot\vec{S}
	...
	\subsection{Gauge Transformation\index{Eichtransformation}}
		...
		\subsubsection{Lorenz gauge\index{Lorenz!gauge}}
			\noindent
	...
	\subsection{Magnetostatics\index{Magnetostatik}}
		...
		\subsubsection{Magnets}
			\noindent
			Bound current density and boud surface current density:
