...
\section{Electromagnetism\index{Elektromagnetismus}}
	...
	\subsection{Field Equations}
		...
		\begin{array}{rl}
			...
			&\hsp \Psi(\partial\mathcal{V}) = Q_f(\mathcal{V}) \\ \xrowht{40pt}
		...
		\begin{array}{cc}
			...
			&\hsp \vec{H}_\parallel^2 - \vec{H}_\parallel^1 = \vec{K}_f\times\Vec{n}^2
		\end{array}
		\end{equation}
	...
	\subsection{Electrodynamics\index{Elektrodynamik}}
		...
		\subsubsection{Electromagnetic Waves in a Vacuum}
			...
			\noindent
			Dispersion relation\index{Dispersionsrelation}
			\begin{equation}
			...
			\begin{equation}
				\begin{aligned}
					u_{EM} &= \frac{1}{2}\epsilon_0\vec{E}^2 &\hsp
			...
			\begin{equation}
				\begin{aligned}
					u_{EM} &= \epsilon_0\vec{E}^2 &\hsp
					I &= \langle|\vec{S}|\rangle = c\epsilon_0\vec{E}^2
				\end{aligned}
			\end{equation}

			\noindent
			Emitted wave of an oscillating dipole\index{Dipol!Strahlung} $\vec{p} = \vec{p}_0 e^{-\i\omega t}$ (Retarded time $\tilde{t} = t-\frac{\left|\vec{r}-\vec{r}'\right|}{c}$):
			\begin{equation}
				\begin{aligned}
	...
	\subsection{Special Solutions of the Field Equations}
		\subsubsection{Retarded Potentials\index{Retardierte Potentiale}}
			...
			\begin{equation}
				\begin{aligned}
					...
					= \frac{1}{4\pi\epsilon_0} \int_{\mathbb{R}^3} \frac{\rho(\tilde{t},\vec{r}')}{\left|\vec{r}-\vec{r}'\right|}\;\dd^3 \vec{r}'
					&=	\frac{1}{4\pi\epsilon_0} \int_{\mathbb{R}^4} \frac{\rho(t',\vec{r}')}{\left|\vec{r}-\vec{r}'\right|}\delta\left( c(t-t')-\left|\vec{r}-\vec{r}'\right|\right)\,\dd^3 \vec{r}'\dd t' \\
					\vec{A}\left(t,\vec{r}\right)
					= \phantom{\epsilon_0} \frac{\mu_0}{4\pi} \int_{\mathbb{R}^3} \frac{\vec{j}(\tilde{t},\vec{r}')}{\left|\vec{r}-\vec{r}'\right|}\,\dd^3 \vec{r}'
					&=	\phantom{\epsilon_0} \frac{\mu_0}{4\pi} \int_{\mathbb{R}^4} \frac{\vec{j}(t',\vec{r}')}{\left|\vec{r}-\vec{r}'\right|}\delta\left( c(t-t')-\left|\vec{r}-\vec{r}'\right|\right)\;\dd^3 \vec{r}'\dd t' \\
		...
		\subsubsection{Liénard-Wiechert Potentials\index{Liénard!-Wiechert Potentiale}}
			\noindent
			Liénard-Wiechert potentials\index{Liénard!-Wiechert Potentiale} (Solutions of the field equations for a moving point charge at $\vec{r}_c(\tilde{t})$ and velocity $\vec{v}(\tilde{t})$; retarded time $\tilde{t}$, $\vec{R}= \vec{r}-\vec{r}_c(\tilde{t})$):
			\begin{equation}
	...
	\subsection{Electrostatics\index{Elektrostatik}}
		\subsubsection{Basics}
			...
			\begin{equation}
				\phi\left(t,\vec{r}\right)
				= \frac{1}{4\pi\epsilon_0} \int_{\mathbb{R}^3} \frac{\rho(\vec{r}')}{\left|\vec{r}-\vec{r}'\right|}\;\dd^3 \vec{r}'
			\end{equation}
		...
		\subsubsection{Multipole Expansion\index{Multipolentwicklung}}
			...
			\begin{equation}
				\begin{aligned}
					\phi(\vec{r}) = \frac{1}{4\pi\epsilon_0}\int\frac{\rho(\vec{r}')}{\left|\vec{r}-\vec{r}'\right|}\;\dd \vec{r}'
					...
					=& \frac{1}{4\pi\epsilon_0}\frac{1}{r}\int\rho(\vec{r}')\;\dd \vec{r}' \\
					&+ \frac{1}{4\pi\epsilon_0}\frac{1}{r}\int\rho(\vec{r}')\left(\frac{r'}{r}\right)\cos\theta\;\dd \vec{r}' \\
					&+ \frac{1}{4\pi\epsilon_0}\frac{1}{r}\int\rho(\vec{r}')\left(\frac{r'}{r}\right)^2\frac{3\cos^2\theta-1}{2}\;\dd \vec{r}' \\
			...
			\begin{equation}
				\begin{aligned}
					...
					b_{lm} &= \frac{1}{(2l+1)\epsilon_0}\int\rho(\vec{r}')r'^lY^{*}_{lm}(\theta',\varphi')\;\dd^3\vec{r}'
				\end{aligned}
			\end{equation}
		...
		\subsubsection{Dielectric\index{Dielektrikum}}
			...
			\noindent
			Polarization density in homogeneous, isotropic, linear dielectrics (Electric susceptibility\index{Elektrische Suszeptibilität} $\chi_e$):
			\begin{equation}
				\begin{aligned}
	...
	\subsection{Magnetostatics\index{Magnetostatik}}
		\subsubsection{Basics}
			...
			\noindent
			Charged particles in a homogeneous magnetic field move on circles with Gyroradius/Larmor radius\index{Larmor!Radius} $r_L$ and gyration frequency\index{Zyklotronfrequenz} $\omega$:
			\begin{equation}
				\begin{aligned}
					r_L = \frac{p}{qB} &&\hsp % horizontal space
					\omega = \frac{|q| B}{m}
				\end{aligned}
			\end{equation}
		...
		\subsubsection{Multipole Expansion}
			...
			\noindent
			Force, torque (with respect to the center of mass) and potential energy of a magnetic dipole\index{Magnetisches Dipolmoment}:
			\begin{equation}
				\begin{aligned}
