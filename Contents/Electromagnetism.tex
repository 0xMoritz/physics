...
\section{Electromagnetism\index{Elektromagnetismus}}
	...
	\subsection{Electrostatics\index{Elektrostatik}}
		...
		\subsubsection{Multipole Expansion\index{Multipolentwicklung}}
			\noindent
			Multipole expansion\index{Multipolentwicklung} in cartesian coordinates (expansion of the general solution in $r'/r \rightarrow 0$):
			\begin{equation}
				\begin{aligned}
	...
	\subsection{Magnetostatics\index{Magnetostatik}}
		...
		\subsubsection{Multipole Expansion}
			\noindent
			Multipole expansion\index{Multipolentwicklung} (Expansion of the general solution in $r'/r \rightarrow 0$):
			\begin{equation}
				\begin{aligned}
