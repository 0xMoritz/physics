...
\section{Relativity}
	...
	\subsection{General Relativity\index{Allgemeine Relativitätstheorie}}
		...
		\subsubsection{Black Holes}
			...
			\noindent
			Reissner-Nordström metric\index{Reissner-Nordström!Metrik} (where $r_Q = \frac{Q^2 G}{4\pi \varepsilon_0 c^4}$ is the charge radius):
			\begin{equation}
			...
			\noindent
			Black Hole Entropy\index{Schwarzes Loch!Entropie} / Bekenstein Hawking formula\index{Bekenstein!-Hawking Formel} (where $A$ is the event horizon area, \eg a Schwarzschild black hole has $A=4\pi r_s^2$):
			\begin{equation}
	...
	\subsection{Special Relativity\index{Spezielle Relativitätstheorie}}
		...
		\subsubsection{Implications of Special Relativity}
			...
			\noindent
			Energymomentum relation\index{Energie-Impuls-Relation}:
			\begin{equation}
				\begin{aligned}
					P^\mu P_\mu &= m^2 c^2\\
					E^2 &= p^2 c^2 + m^2 c^4 \\
