...
\section{Relativity}
	...
	\subsection{General Relativity\index{Allgemeine Relativitätstheorie}}
		\subsubsection{Definitions}
			...
			\begin{equation}
				\Gamma_{\mu\nu}^{\kappa} \defeq \frac{\partial x^\kappa}{\partial \xi^\alpha}\frac{\partial^2 \xi^\alpha}{\partial x^\mu\partial x^\nu}
			...
			\begin{equation}
				\Delta\tau \defeq \frac{1}{c}\int_A^B\sqrt{-g_{\mu\nu}\dd x^\mu \dd x^\nu}
			\end{equation}
		...
		\subsubsection{Tensors}
			...
			\noindent
			Divergence of the Einstein tensor / Bianchi identity\index{Bianchi!Identitäten} for the Einstein tensor\index{Einstein!Tensor} / Noether identity for the diffeomorphism symmetry:
			\begin{equation}
				\nabla_\mu G^{\mu\nu} = 0
			\end{equation}
		...
		\subsubsection{Geodesics\index{Geodäten}}
			...
			\noindent
			Killing's Equation\index{Killing!Gleichung}\index{Killing!Vector}
			\begin{equation}
				\begin{aligned}
			...
			\noindent
			Surface gravity $\kappa$ (for a stationary Killing vector field\index{Killing!Vektor} $\xi^\mu$):
			\begin{equation}
			    \xi^\nu \nabla_\nu \xi^\mu = \kappa \xi^\mu
			\end{equation}
		...
		\subsubsection{Black Holes}
			...
			\noindent
			Kerr Metric\index{Kerr!Metrik} (in Boyer--Lindquist coordinates\index{Boyer!--Lindquist Koordinaten}\index{Lindquist!Boyer--Lindquist Koordinaten}, where $\Delta\defeq r^2 - 2Mr + a^2$ and $\rho^2\defeq r^2+a^2\cos^2\theta$):
			\begin{equation}
				\begin{aligned}
