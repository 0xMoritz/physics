...
\section{Relativity}
	...
	\subsection{General Relativity\index{Allgemeine Relativitätstheorie}}
		...
		\subsubsection{Black Holes}
			...
			\noindent
			Black Hole Entropy\index{Schwarzes Loch!Entropie} / Bekenstein Hawking formula\index{Bekenstein!-Hawking Formel} ($A$ is the event horizon area, \eg a Schwarzschild black hole has $A=4\pi r_s^2$):
			\begin{equation}
