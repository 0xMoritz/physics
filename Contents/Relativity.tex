...
\section{Relativity}
	...
	\subsection{General Relativity\index{Allgemeine Relativität}}
	...
	\subsection{Spezielle Relativität}
		...
		\subsubsection{Lorentztransformation}
			...
			\noindent
			Condition for the Lorentz Transformation following from the constancy of the speed of light \ref{post:c}:%Bedingung an die Lorentztransformation als Folge der Konstanz der Lichtgeschwindigkeit:
			\begin{equation}
