...
\section{Quantum Gravity}
	...
	\subsection{Flow Equations}
		...
		\noindent
		Flowing / Scale dependent effective action and modified quantum equations of motion ($\phi(x)= \fdv{W_k[J]}{J(x)}$):
		\begin{equation}
		...
		\noindent
		Wetterich Equation\index{Wetterich-Gleichung} / flow equation for the effective action:
		\begin{equation}
