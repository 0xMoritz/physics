...
\section{Thermodynamics}
	...
	\subsection{Entropy}
		...
		\subsubsection{Information Theory}
			...
			\indent \emph{The deletion of one bit of information requires the dissipation of $\Delta W = k_B T \ln 2$ of energy.}\nl
			\noindent
	...
	\subsection{Model Systems}
		...
		\subsubsection{Black Body}
			...
			\noindent
			Wien's displacement law\index{Wien!Verschiebungsgesetz} (For the wavelength or frequency of the $\lambda_{\max}$ emission maximum; $x_\lambda$ solves $(x_\lambda-5)\ex^{x_\lambda}+5=0$, $x_f$ solves $(3-x_f)\ex^{x_f}+3=0$):
			\begin{equation}
				\begin{aligned}
