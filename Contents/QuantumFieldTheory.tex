...
\section{Quantum Field Theory\index{QFT}\index{Quantenfeldtheorie}} % QFt
	...
	\subsection{Fermions}
		...
		\label{Sec:FermionicCreationAndAnnihilationOperators}
			...
			\end{equation}
			In particular $\hat{a}_k^\dagger \hat{a}_k^\dagger = 0 = \hat{a}_k \hat{a}_k$, which ensures $n_k\in\cBr{0,1}$, \ie the Pauli exclusion principle\index{Pauli!Ausschlussprinzip}.
