...
\subsection{Basics}
	...
	\subsection{Feynman Path Integral\index{Feynman!Pfadintegral}}
		...
		\subsubsection{Generating Functionals}
			...
			\noindent
			Schwinger\index{Schwinger!Funktional} functional:
			\begin{equation}
				W\qty[J] = \ln Z\qty[J]
			\end{equation}

			\noindent
			Effective Action\index{Effektive!Wirkung} (\ie the Legendre Transformation\index{Legendre!Transformation} of the Schwinger Functional\index{Schwinger!Funktional}):
			\begin{equation}
