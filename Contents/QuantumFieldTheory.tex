...
\section{Quantum Field Theory\index{QFT}\index{Quantenfeldtheorie}} % QFT
	...
	\subsection{Fermions}
		...
		\subsubsection{Dirac Spinors\index{Dirac!Spinor}}
			...
			\end{equation}
			\begin{itemize} \itemsep -0pt
				\item particle with spin up: $\xi=\xi^1 = (1, 0)^T$
				\item particle with spin down: $\xi=\xi^2 = (0, 1)^T$
				\item antiparticle with spin up: $\chi=\chi^1 = (0, 1)^T$
				\item antiparticle with spin down: $\chi=\chi^2 = (1, 0)^T$
			\end{itemize}
