...
\subsection{Basics}
		...
		\subsubsection{Scattering}
			\subsubsection{Mandelstam Variables\index{Mandelstam!Variablen}}
				\noindent
				Lorentz scalars\index{Lorentz!Skalare} in scattering processes of the form: $P_1 + P_2 \rightarrow P_3 + P_4$:
	...
	\subsection{Fermions}
		...
		\subsubsection{Weyl Spinors\index{Weyl!Spinor}}
			...
			\begin{equation}
				...
				= \mqty(
					...
					\end{equation}
			\begin{equation}
				\Lambda_L^\dagger = \Lambda_R^{-1} \hsp \Lambda_R^\dagger = \Lambda_L^{-1}
			\end{equation}
			...
			\begin{equation}
				\psi_L' = \Lambda_{L} \psi_L \Lambda_{L}^\dagger \hsp
				\psi_R' = \Lambda_{R} \psi_R \Lambda_{R}^\dagger 
			\end{equation}
		...
		\subsubsection{Dirac Spinors\index{Dirac!Spinor}}
			...
			\end{equation}
			note, that the Dirac Equation implies the Klein-Gordon Equation\index{Klein!-Gordon Gleichung}.
			...
			\begin{equation}
				\begin{aligned}
					\text{particles} & \hsp
					\psi(x) = u(p) e^{-\i p \cdot x} = \mqty(
						u_L(p) \\
						u_R(p)
						) e^{-\i p \cdot x} \\
					\text{antiparticles} & \hsp
					\bar{\psi}(x) = v(p) e^{\i p \cdot x} = \mqty(
						v_L(p) \\
						v_R(p)
						) e^{\i p \cdot x}
				\end{aligned}
			...
			\end{equation}
			for particles spin up would mean $\xi=\xi^1=\mqty(1\\0)$ and spin down would mean $\xi=\xi^2=\mqty(0\\1)$.
			for antiparticles spin up would mean $\eta=\eta^1=\mqty(0\\1)$? and spin down would mean $\eta=\eta^2=\mqty(1\\0)$?.

			\noindent
			Adjoint spinor $\bar{u}$ of a spinor $u$:
			\begin{equation}
			...
			\begin{equation}
				\begin{aligned}
					\psi^{-}(x) &= \int\frac{\dd^{3}p}{(2\pi)^{\frac{3}{2}}}\frac{1}{\sqrt{2E_{\vec{p}}}}\sum_{s=1}^{2}a_{s, \vec{p}}u^{s}(p)e^{-\i p\cdot x} \\
					\psi^{+}(x) &= \int\frac{\dd^{3}p}{(2\pi)^{\frac{3}{2}}}\frac{1}{\sqrt{2E_{\vec{p}}}}\sum_{s=1}^{2}{b_{s, \vec{p}}^{*}}v^{s}(p)e^{\i p\cdot x}
				\end{aligned}
			\end{equation}
			...
			\begin{equation}
				\hat{H}\psi = \frac{(\vec{\sigma}\cdot\hat{\vec{p}})^2}{2m} \psi
			\end{equation}
			...
			\end{equation}
			corresponding Noether current operator:
			\begin{equation}
			...
			\begin{equation}
				\begin{aligned}
					D_F(x-y) &= \mel**{0}{T\hat{\psi}(x)\hat{\bar\psi}(y)}{0} \\
					&= \int \frac{\dd^4 p}{(2\pi)^4} \frac{\i(\slashed{p}+m)}{p^2-m^2+\i\epsilon} e^{-\i p\cdot(x-y)} \\
	...
	\subsection{Quantum Electrodynamics}
		...
		\begin{itemize}\itemsep -0pt
			...
			\item Charged particle propagator $\psi \in \qty{e^\pm, \mu^\pm ,\tau^\pm, u,d,s,c,t,b}$: $D_F(x-y) = \i\qty(\frac{\slashed{p}+m_\psi}{p^2-m_\psi^2+\i\epsilon})$
