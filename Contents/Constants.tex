		...
		\subsubsection{Natural Units}
			...
			\begin{center}
				\begin{tabular}{| L{.25\textwidth} L{.2\textwidth} L{.25\textwidth} |}
					...
					Planck Mass\index{Planck, Max!Masse} & $m_P = \sqrt{\dfrac{\hbar c}{G}}$ & $2.176\,434(24)\e{-8}\unit{kg}$  $1.220\,890(14)\e{28}\unit{eV}$  \\ \hline
					Planck Length\index{Planck, Max!Länge} & $l_P = \sqrt{\dfrac{\hbar G}{c^3}}$ & $1.616\,255(18)\e{-35}\unit{m}$ \\ \hline
					Planck Time\index{Planck, Max!Zeit} & $t_P = \sqrt{\dfrac{\hbar G}{c^5}}$ & $5.391\,247(60)\e{-44}\unit{s}$ \\ \hline
					Planck Temperature\index{Planck, Max!Temperatur} & $T_P = \sqrt{\dfrac{\hbar c^5}{G \kB}}$ & $1.416\,784(16)\e{32}\unit{K}$ \\ \hline
				\end{tabular}
			\end{center}
