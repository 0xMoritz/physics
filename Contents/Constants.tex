...
\section{Constants}
	\subsection{Fundamental Constants}
		...
		\begin{tabular}{| L{.35\textwidth} L{.15\textwidth} L{.4\textwidth} |}
			...
			\hline\xrowht{12pt}
			\href{https://en.wikipedia.org/wiki/Planck_constant}{Planck's Constant}\index{Planck!Wirkungsquantum} & $h$ & $6.626\,070\,15\e{-34}\unit{J\,s}$ \exact \\
			\hline\xrowht{12pt}
			\href{https://en.wikipedia.org/wiki/Gravitational_constant}{Gravitational Constant}\index{Newton!Gravitationskonstante} & $G$ & $6.674\,30(15)\e{-11}\;\frac{\mathrm{m^3}}{\mathrm{kg\,s^2}} $ \\
			\hline\xrowht{12pt}
			\href{https://en.wikipedia.org/wiki/Elementary_charge}{Elementary charge}\index{Elementarladung} & $e$ & $1.602\,176\,634\e{-19}\unit{C}$ \exact \\
			\hline\xrowht{12pt}
			\href{https://en.wikipedia.org/wiki/Vacuum_permittivity}{Vacuum permittivity} \index{Vakuum!Permittivität} & $\varepsilon_0$ & $8.854\,187\,812\,8(13)\e{-12}\;\frac{\mathrm{A\,s}}{\mathrm{V\,m}}$ \\
			\hline\xrowht{12pt}
			\href{https://en.wikipedia.org/wiki/Vacuum_permeability}{Vacuum permeability} \index{Vakuum!Permeabilität} & $\mu_0$ & $1.256\,637\,062\,12(19)\e{-6}\;\frac{\mathrm{N}}{\mathrm{A^2}}$ \\
			\hline\xrowht{12pt}
			\href{https://en.wikipedia.org/wiki/Boltzmann_constant}{Boltzmann constant}\index{Boltzmann!Konstante} & $k_B$ & $1.380\,649\e{-23}\;\frac{\mathrm{J}}{\mathrm{K}}$ \exact\\
			\hline\xrowht{12pt}
			\href{https://en.wikipedia.org/wiki/Avogadro_constant}{Avogadro constant}\index{Avogadro!Konstante} & $N_A$ & $6.022\,140\,76\e{23}\;\frac{1}{\mathrm{mol}}$ \exact \\
			\hline
		\end{tabular}
		\end{center}
	...
	\subsection{Composite Constants}
		...
		\begin{tabular}{| L{.35\textwidth} L{.19 \textwidth} L{.36\textwidth} |}
			...
			\hline
			\hline\xrowht{23pt}
			\href{https://en.wikipedia.org/wiki/Planck_constant#Reduced_Planck_constant}{Reduced Planck's Constant} & $\hbar:=\dfrac{h}{2\pi}$ & $1.054\,571\,817...\e{-34}\unit{J\,s}$ \\
			\hline\xrowht{23pt}
			\href{https://en.wikipedia.org/wiki/Stefan%E2%80%93Boltzmann_constant}{Stefan-Boltzmann Constant}\index{Stefan!-Boltzmann Konstante} & $\sigma:=\dfrac{2\pi^5 k_B^4}{15h^3c^2}$ & $5.670\,374\,419...\e{-8}\;\frac{\mathrm{W}}{\mathrm{m^2\,K^4}}$ \\
			\hline\xrowht{23pt}
			\href{https://en.wikipedia.org/wiki/Rydberg_constant}{Rydberg constant}\index{Rydberg!Konstante} & $R_\infty := \dfrac{m_e e^4}{8 c h^3 \varepsilon_0^2}$ & $1.097\,373\,156\,816\,0(2\,1)\e{7}\;\frac{1}{\mathrm{m}}$ \\
			\hline\xrowht{23pt}
			\href{https://en.wikipedia.org/wiki/Rydberg_constant#Rydberg_unit_of_energy}{Rydberg-Energy}\index{Rydberg!Energie} & $R_y := \dfrac{m_e e^4}{8 h^2 \varepsilon_0^2}$ & $2.179\,872\,361\,103\,5(4\,2)\e{-18}\unit{J}$ \\
			\hline\xrowht{23pt}
			\href{https://en.wikipedia.org/wiki/Bohr_radius}{Bohr radius}\index{Bohr!Radius} & $\rho := \dfrac{4\pi\hbar^2\varepsilon_0}{m_e e^2}$ & $5.291\,772\,109\,03(80) \e{-11}\unit{m}$ \\
			\hline\xrowht{23pt}
			\href{https://en.wikipedia.org/wiki/Fine-structure_constant}{Fine structure constant}\index{Feinstrukturkonstante} & $\alpha := \dfrac{e^2}{4\pi\varepsilon_0\hbar c}$ & $7.297\,352\,537\,6(5\,0) \e{-3} \approx\frac{1}{137}$ \\
			\hline\xrowht{23pt}
			\href{https://en.wikipedia.org/wiki/Bohr_magneton}{Bohr magneton}\index{Bohr!Magneton} & $\mu_B := \dfrac{e \hbar}{2 m_e}$ & $9.274\,009\,994\,(57)\e{-24}\;\frac{\mathrm{J}}{\mathrm{T}}$ \\
			\hline\xrowht{23pt}
			\href{https://en.wikipedia.org/wiki/Nuclear_magneton}{Nuclear magneton}\index{Kern Magneton} & $\mu_K := \dfrac{e \hbar}{2 m_p}$ & $5.050\,783\,746\,1(1\,5)\e{-27}\;\frac{\mathrm{J}}{\mathrm{T}}$ \\
			\hline\xrowht{23pt}
			\href{https://en.wikipedia.org/wiki/Classical_electron_radius}{Classical electron radius}\index{Klassischer Elektronenradius} & $r_e := \dfrac{e^2}{4\pi\varepsilon_0 m_e c^2}$ & $2.817\,940\,322\,7(1\,9)\e{-15}\;\mathrm{m}$ \\
			\hline
		\end{tabular}
		\end{center}
	...
	\subsection{Astronomical Constants}
		...
		\begin{tabular}{| L{.35\textwidth} L{.15\textwidth} L{.4\textwidth} |}
			...
			\hline\xrowht{12pt}
			\href{https://en.wikipedia.org/wiki/Solar_constant}{Solar constant}\index{Solarkonstante} & $E_0$ & $1361 \unit{\frac{W}{m^2}}$ \\
			\hline\xrowht{12pt}
	...
	\subsection{Units}
		...
		\begin{tabular}{| L{.35\textwidth} L{.15\textwidth} L{.4\textwidth} |}
			...
			\hline\xrowht{23pt}
			\href{https://en.wikipedia.org/wiki/Light-year}{Light-year}\index{Lichtjahr} & $\mathrm{ly}$ & $9\,460\,730\,472\,580\,800\unit{m}$ \\
			\hline\xrowht{23pt}
			...
			\hline\xrowht{23pt}
			\href{https://en.wikipedia.org/wiki/Dalton_(unit)}{Dalton / Atomic mass unit}\index{Atomare Masseneinheit} & $\mathrm{u}$, $\mathrm{Da}$ & $\frac{1}{12}m(\prescript{12}{6}{\mathbf{C}})=1.660\,539\,066\,60(50)\e{-27}\unit{kg}$ \\
			\hline\xrowht{23pt}
			\href{https://en.wikipedia.org/wiki/Erg}{Erg} & $\mathrm{erg}$ & $10^{-7}\,\mathrm{J}$ \\
			\hline\xrowht{23pt}
			\href{https://en.wikipedia.org/wiki/Calorie}{Calorie\index{Calorie!Einheit}} & $\mathrm{cal}$ & $4\,184\,\mathrm{J}$ \\
			\hline\xrowht{23pt}
			...
			\hline\xrowht{23pt}
			\href{https://en.wikipedia.org/wiki/Gauss_(unit)}{Gauß}\index{Gauß!Einheit} & $\mathrm{Gs}$ & $10^{-4}\unit{T}$ \\
			\hline\xrowht{23pt}
