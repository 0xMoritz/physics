	...
	\subsection{Particle Constants}
		...
		\begin{center}
			\begin{tabular}{| L{.35\textwidth} L{.15\textwidth} L{.4\textwidth} |}
				...
				\href{https://en.wikipedia.org/wiki/Higgs_boson}{Higgs-Boson mass}\index{Higgs!Boson} & $m_H$ &
	...
	\subsection{Composite Constants}
		\begin{center}
			\begin{tabular}{| L{.35\textwidth} L{.19 \textwidth} L{.36\textwidth} |}
				...
				\href{https://en.wikipedia.org/wiki/Planck_constant#Reduced_Planck_constant}{Reduced Planck's Constant} & $\hbar\defeq \dfrac{h}{2\pi}$ & $1.054\,571\,817...\e{-34}\unit{J\,s}$ \\[3pt] \hline
				\href{https://en.wikipedia.org/wiki/Stefan%E2%80%93Boltzmann_constant}{Stefan--Boltzmann Constant}\index{Stefan!--Boltzmann Konstante}\index{Boltzmann!Stefan--Boltzmann Konstante} & $\sigma\defeq \dfrac{2\pi^5 \kB^4}{15h^3c^2}$ & $5.670\,374\,419...\e{-8}\;\frac{\mathrm{W}}{\mathrm{m^2\,K^4}}$ \\[3pt] \hline
				\href{https://en.wikipedia.org/wiki/Rydberg_constant}{Rydberg constant}\index{Rydberg!Konstante} & $R_\infty \defeq \dfrac{m_e e^4}{8 c h^3 \varepsilon_0^2}$ & $1.097\,373\,156\,816\,0(2\,1)\e{7}\;\frac{1}{\mathrm{m}}$ \\[3pt] \hline
				\href{https://en.wikipedia.org/wiki/Rydberg_constant#Rydberg_unit_of_energy}{Rydberg-Energy}\index{Rydberg!Energie} & $R_y \defeq \dfrac{m_e e^4}{8 h^2 \varepsilon_0^2}$ & $2.179\,872\,361\,103\,5(4\,2)\e{-18}\unit{J}$ \\[3pt] \hline
				\href{https://en.wikipedia.org/wiki/Bohr_radius}{Bohr radius}\index{Bohr!Radius} & $\rho \defeq \dfrac{4\pi\hbar^2\varepsilon_0}{m_e e^2}$ & $5.291\,772\,109\,03(80) \e{-11}\unit{m}$ \\[3pt] \hline
				\href{https://en.wikipedia.org/wiki/Fine-structure_constant}{Fine structure constant}\index{Feinstrukturkonstante} & $\alpha \defeq \dfrac{e^2}{4\pi\varepsilon_0\hbar c}$ & $7.297\,352\,537\,6(5\,0) \e{-3} \approx\dfrac{1}{137}$ \\[3pt] \hline
				Fermi coupling constant\index{Fermi!Kopplungskonstante} & $G_F \defeq \dfrac{\sqrt{2} g^2}{8 m_W^2 c^4}$ & $1.166\,378\,7(6)\unit{GeV^{-2}}$ \\[3pt] \hline
				\href{https://en.wikipedia.org/wiki/Bohr_magneton}{Bohr magneton}\index{Bohr!Magneton} & $\mu_\text{B} \defeq \dfrac{e \hbar}{2 m_e}$ & $9.274\,009\,994\,(57)\e{-24}\;\frac{\mathrm{J}}{\mathrm{T}}$ \\[3pt] \hline
				\href{https://en.wikipedia.org/wiki/Nuclear_magneton}{Nuclear magneton}\index{Kern Magneton} & $\mu_\text{N} \defeq \dfrac{e \hbar}{2 m_p}$ & $5.050\,783\,746\,1(1\,5)\e{-27}\;\frac{\mathrm{J}}{\mathrm{T}}$ \\[3pt] \hline
				\href{https://en.wikipedia.org/wiki/Classical_electron_radius}{Classical electron radius}\index{Klassischer Elektronenradius} & $r_e \defeq \dfrac{e^2}{4\pi\varepsilon_0 m_e c^2}$ & $2.817\,940\,322\,7(1\,9)\e{-15}\;\mathrm{m}$ \\[3pt] \hline
			\end{tabular}
		\end{center}
		...
		\subsubsection{Natural Units}
			...
			\begin{center}
				\begin{tabular}{| L{.25\textwidth} L{.2\textwidth} L{.25\textwidth} |}
					...
					Planck Mass\index{Planck, Max!Masse} & $\mPl = \sqrt{\dfrac{\hbar c}{G}}$ & $2.176\,434(24)\e{-8}\unit{kg}$  $1.220\,890(14)\e{28}\unit{eV}$  \\ \hline
					Planck Length\index{Planck, Max!Länge} & $l_{\text{Pl.}} = \sqrt{\dfrac{\hbar G}{c^3}}$ & $1.616\,255(18)\e{-35}\unit{m}$ \\ \hline
					Planck Time\index{Planck, Max!Zeit} & $t_{\text{Pl.}} = \sqrt{\dfrac{\hbar G}{c^5}}$ & $5.391\,247(60)\e{-44}\unit{s}$ \\ \hline
					Planck Temperature\index{Planck, Max!Temperatur} & $T_{\text{Pl.}} = \sqrt{\dfrac{\hbar c^5}{G \kB}}$ & $1.416\,784(16)\e{32}\unit{K}$ \\ \hline
				\end{tabular}
			\end{center}
