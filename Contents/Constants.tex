	...
	\subsection{Fermion Quantum Numbers}
		...
		\begin{center}
			\begin{tabular}{| L{.46\textwidth} | L{.46\textwidth} |}
				...
				$u_R,c_R,t_R$ ($Y=+2/3, T=T_3=0, Q=+4/3$)

				$d_R,s_R,b_R$ ($Y=-1/3, T=T_3=0, Q=-2/3$)
				&
	...
	\subsection{Composite Constants}
		\begin{center}
			\begin{tabular}{| L{.35\textwidth} L{.19 \textwidth} L{.36\textwidth} |}
				...
				\href{https://en.wikipedia.org/wiki/Stefan%E2%80%93Boltzmann_constant}{Stefan--Boltzmann Constant}\index{Stefan!--Boltzmann Konstante}\index{Boltzmann!Stefan--Boltzmann Konstante} & $\sigma:=\dfrac{2\pi^5 \kB^4}{15h^3c^2}$ & $5.670\,374\,419...\e{-8}\;\frac{\mathrm{W}}{\mathrm{m^2\,K^4}}$ \\[3pt] \hline
