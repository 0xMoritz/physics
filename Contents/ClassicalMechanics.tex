...
\section{Classical Mechanics\index{Klassische Mechanik}}
	...
	\subsection{Hamiltonian Formalism}
		...
		\noindent
		Boltzmann Equation\index{Boltzmann!Gleichung} (Special case of Liouville's theorem\index{Liouville!Theorem} (Eq.~\ref{eq:LiouvilleTheorem}), describing the distribution function for statistically uncorrelated particles; $f(\vec{q},\vec{p},t)$ is the phase space distribution function normalized to $f(\vec{q},\vec{p},t)\,\dd^3 p \,\dd^3 q = \dd N$ and $\mathcal{C}[f]$ is the collision term):
		\begin{equation}
