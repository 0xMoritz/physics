...
\section{Classical Mechanics\index{Klassische Mechanik}}
	...
	\subsection{Basics}
		...
		\noindent
		Derivative of angular momentum\index{Drallsatz} (Torque\index{Drehmoment} $\vec{\tau}$):
		\begin{equation}
			\dv{\vec{L}}{t} = \vec{\tau}
		\end{equation}
	...
	\subsection{Lagrange-Formalism}
		...
		\subsubsection{Kepler Problem\index{Kepler!Problem}}
			...
			\noindent
			Rocket Equation\index{Raketengleichung} (final mass $m_\text{f}$, initial mass $m_\text{i}$, exhaust speed $u$, specific Impulse $I_{\text{sp.}}$, standard earth acceleration $g_0$):
			\begin{equation}
