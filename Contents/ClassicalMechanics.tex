	...
	\subsection{Moving Coordinate Systems}
		...
		\begin{equation}
			\begin{aligned}
				...
				m\dv{\vec{p}'}{t} &= \vec{F} + \vec{F}_T + \vec{F}_Z + \vec{F}_L + \vec{F}_C \\
			\end{aligned}
		\end{equation}
		...
		\begin{equation}
			\begin{aligned}
				\vec{F}_T &= -m\dv[2]{\vec{x}_0}{t} &\hsp
				\vec{F}_Z &= -m\vec{\omega}\times\qty(\vec{\omega}\times\vec{x}') \\
				\vec{F}_L &= -m\dv{\vec{\omega}}{t}\times\vec{x}' &\hsp
				\vec{F}_C &= -2m\vec{\omega}\times\dv{\vec{x}'}{t} \\
			\end{aligned}
		\end{equation}
